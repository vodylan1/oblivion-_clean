...
async def test_nyx_buy():
    md = MarketData(
        price=1, lp_depth=50_000, meme_hype=70, whale_inflow=0, volatility=30
    )
...
async def test_inventor_low_conf_buy():
    md = MarketData(
        price=1, lp_depth=5_000, meme_hype=30, whale_inflow=0, volatility=10
    )
...
async def test_shadow_buy_and_sell():
    ...
    buy_md = MarketData(
        price=1, lp_depth=1_000, meme_hype=20, whale_inflow=0, volatility=10
    )
    sell_md = MarketData(
        price=1, lp_depth=1_000, meme_hype=60, whale_inflow=0, volatility=10
    )

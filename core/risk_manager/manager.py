...
class RiskManager:
    ...
    def bucket_cap(self) -> int:
        ...
        # Phase‑11 strategies query this as a FUNCTION, e.g. capital_tier()
    def capital_tier(self) -> int:            # ← no @property decorator
        """Tier 0 = micro‑cap until dynamic sizing arrives."""
        return 0
